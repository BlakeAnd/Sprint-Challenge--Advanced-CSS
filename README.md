...
Adaptive is an older model of accounting for different screen sizes, it uses information about the type of device the user is browsing on to retrieve different styling for the webpage. Responsive is more common/standard at this point in time, it uses media queries based on certain screen widths to alter certain parts of the styling. 
